...
//        } );
        ...
        mapWidget = (MapView) findViewById( R.id.map_widget );
//        mapWidget.initMap(new MapView.OnMapReadyListener() {
//            @Override
...
//        });
        ...
        exchngButton = (Button)findViewById(R.id.exchng);
        exchngButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                exchngView(isMapMini);
            }
        });
        initMap();
...
//        }
    ...
    // 交换视窗 2019.07.23
    private void exchngView(boolean isMapMini){
        if (isMapMini) {  //　 地图放大，视窗缩小。
//            RelativeLayout.LayoutParams fpvParams = (RelativeLayout.LayoutParams) fpvWidget.getLayoutParams();
//            ResizeAnimation fpvWidgetAnimation = new ResizeAnimation(fpvWidget, deviceWidth, deviceHeight, width, height, margin);
//            fpvWidget.startAnimation(fpvWidgetAnimation);
            ResizeAnimation mapViewAnimation = new ResizeAnimation(mapWidget, width, height, deviceWidth, deviceHeight, 0);
...
//        fpvParams.topMargin = deviceHeight - height;
//        fpvParams.leftMargin = deviceWidth - width;
